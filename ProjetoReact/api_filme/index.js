...
const filmesImportados = require('./services/filmeServices'); 

const usersServices = require('./services/usuarioServices'); //npm i body-parser instalamos para receber no corpo do json
...
app.get('/buscarFilmesPorTitulo/:titulo', (req, res)=>{
    ...
    const resultado = filmesImportados.buscarPorTitulo(titulo);
