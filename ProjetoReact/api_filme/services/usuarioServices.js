...
exports.addUser = (name,password)=>{
    ...
    const dadosJson = fs.readFileSync('usuarios.json','utf-8');
    ...
    fs.writeFileSync('usuarios.json',JSON.stringify(users),'utf-8');
...
exports.validadeLogin = (name,password) =>{
    ...
    try {
        const userData = JSON.parse(fs.readFileSync('usuarios.json', 'utf-8'));
